...
public abstract class SphericalDistanceLibrary {
    ...
    public static final double distanceP(Coordinate from, Coordinate to) {
        return distanceP(from.y, from.x, to.y, to.x);
    }
    ...
    public static final double distanceP(double lat1, double lon1, double lat2, double lon2) {
        return distance(lat1, lon1, lat2, lon2, RADIUS_OF_EARTH_IN_KM);
    }
