...
public class GeocoderResource {
    ...
    public GeocoderResource (@Context OTPServer otpServer, @PathParam("routerId") String routerId, @QueryParam("username") String username) {
    	//Riccardo (14-07-2017): selecting router depending on the user
//    	System.out.println(username);
    	if(username != null && !username.equals("-1")) routerId = username;
