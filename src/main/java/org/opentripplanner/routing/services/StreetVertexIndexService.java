...
public interface StreetVertexIndexService { //PHUONG: http://novalis.org/talks/otp/slide-36.html#top; StreetVertexIndexService and NetworkLinkerLibrary are used to link transit network to the street network [this class is used to find nearby turn edges]
