...
public class Graph implements Serializable {
    ...
    public Map<AgencyAndId, ServiceCalendar> calendarById;
    public Map<Trip, Frequency> frequencyByTrip;
    public Multimap<AgencyAndId, ServiceCalendarDate> calendarDateById = ArrayListMultimap.create();
    ...
    public Graph() {
        ...
        this.calendarById = new ConcurrentHashMap<AgencyAndId, ServiceCalendar>();
        this.frequencyByTrip = new ConcurrentHashMap<Trip, Frequency>();
    }
    ...
    public static Graph load(ObjectInputStream in, LoadLevel level,
        ...
        try {
        	long currentTime = System.currentTimeMillis();//EDIT - Riccardo (15-03-2017): Record the current time to calculate later how long it needs to load the graph
            ...
            LOG.info("Time needed to load the graph: " + Long.toString((System.currentTimeMillis() - currentTime) / 1000) + "s"); //EDIT - Riccardo (13-03-2017): log of graph loading time
