...
//            System.out.println(v + ": " + v.getLon() + " " + v.getLat());
    ...
    public List<TransitStop> getTransitStopForEnvelope(Envelope envelope) {
        ...
        //Riccardo return sorted stops
        transitStops.sort(new Comparator<TransitStop>(){

			@Override
			public int compare(TransitStop s1, TransitStop s2) {
