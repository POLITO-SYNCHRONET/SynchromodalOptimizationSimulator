...
public class StreetTransitLink extends Edge {
    ...
    public State traverse(State s0) {
       ...
       /* if (s0.backEdge instanceof StreetTransitLink) {
            return null;
        }*/ //PHUONG: disable this statements to avoid un-linkablity when using several GTFS feeds at the same time
        ...
        s1.incrementWAIT1(STL_TRAVERSE_COST + transitStop.getStreetToStopTime());
        s1.setBackMode(TraverseMode.LEG_SWITCH);
        return s1.makeState();
        /*PHUONG: about getStreetToStopTime:     
    ...
    public State optimisticTraverse(State s0) {
        ...
        s1.incrementWAIT1(STL_TRAVERSE_COST);
        s1.setBackMode(TraverseMode.LEG_SWITCH);
        return s1.makeState();
    }
