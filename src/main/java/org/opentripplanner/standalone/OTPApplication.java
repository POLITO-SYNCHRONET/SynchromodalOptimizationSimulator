...
import com.SynchroNET.api.resource.StakeholderAssessmentResource;
import com.SynchroNET.api.resource.UserExperienceResource;
import com.SynchroNET.api.resource.UserResource;
...
public class OTPApplication extends Application {
    ...
    public Set<Class<?>> getClasses() {
        ...
        classes.addAll(Arrays.asList(
        	...
        	StakeholderAssessmentResource.class,
        	UserExperienceResource.class,
        	GTFSResource.class,
        	UserResource.class,
