...
public class GtfsLibrary {
    ...
    public static AgencyAndId convertIdFromString(String value) {
        ...
        System.out.println("AgencyAndId value is "+ value);;
        if (index == -1) {
    ...
    public static String getRouteName(Route route) {
    	//LOG.debug("Check gtfsLibrary {})", route.getLongName());
        // System.out.println("Check gtfsLibrary" + route.getLongName());
        if (route.getShortName() != null)
            return route.getShortName();
        return route.getLongName();
    }
    
    public static String getRouteID(Route route) {
        return route.getId().getId();
    }

    //EDIT - Riccardo (04-05-2017): Retrieve extra data of the routes (ex. costs, CO2,...) 
    public static String getRouteInformation(Route route){
