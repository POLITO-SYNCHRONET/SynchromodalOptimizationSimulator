...
//            System.out.println(input instanceof OsmVertex);
//            System.out.println(distances.get(input.getIndex()) < searchRadiusLat * searchRadiusLat);
...
//            System.out.println(Iterables.filter(input.getOutgoing(), Edge.class));
...
//                }
//            }
            for (Edge e : Iterables.filter(input.getOutgoing(), Edge.class)) {
...
//            System.out.println();
        ...
        System.out.println("sample factory: vertices and sorted");
        System.out.println(vertices);
