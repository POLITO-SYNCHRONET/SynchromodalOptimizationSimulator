...
otp.modules.planner.TripPlan = otp.Class({
    ...
    calculateTimeBounds : function() {
        ...
        for(var i=0; i<this.itineraries.length; i++) {
            ...
            //Shuai (28/04/2017) new method to calculate the max time range
//            for(var j=0; j<this.itineraries[i].itinData.legs.length; j++){
//            	var leg = this.itineraries[i].itinData.legs[j];
//            	this.earliestStartTime = (this.earliestStartTime == null || 
//			                      leg.startTime < this.earliestStartTime) ?
//			                    	leg.startTime : this.earliestStartTime; 
//            	this.latestEndTime = (this.latestEndTime == null || 
//		                          leg.endTime > this.latestEndTime) ?
//		                            leg.endTime : this.latestEndTime;
//            }
        }
